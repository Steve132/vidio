...
void test_writer_no_named_pipe_class(const std::string& filename)
{
	int fd;
...
void test_reader_no_named_pipe_class(const std::string& filename)
{
	int fd1;
